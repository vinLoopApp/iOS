...
@implementation VinLoopDelegate
...
#pragma mark - Core Data (vinloop) stack
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"vinloop" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [directoryURL URLByAppendingPathComponent:@"vinloop.sqlite"];
